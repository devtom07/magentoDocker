 ...
 *   }]);
    ...
    function Browser(window, document, $log, $sniffer) {
         ...
         *
         * @param {string} url Edit url (when used as setter)
 ...
 *     });
    ...
    function $CompileProvider($provide, $$sanitizeUriProvider) {
         ...
         *
         * @param {RegExp=} regexp Edit regexp to whitelist urls with.
    ...
    LocationHashbangInHtml5Url.prototype =
        LocationHashbangUrl.prototype =
            LocationHtml5Url.prototype = {
                 ...
                 *
                 * @param {string=} url Edit url without base prefix (e.g. `/path?a=b#hash`)
                 ...
                 *
                 * @param {string|Object.<string>|Object.<Array.<string>>} search Edit search params - string or
                 ...
                 *
                 * @param {string=} hash Edit hash fragment
                 * @return {string} hash
                 */
...
///////////////////////////////////
    ...
    function $ParseProvider() {
         ...
         *
         *
         * @param {boolean=} value Edit value.
