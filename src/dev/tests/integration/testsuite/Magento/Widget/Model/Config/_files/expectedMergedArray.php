        ...
        'parameters' => [
            'display_type' => [
                ...
                'values' => [
                    ...
                    'item' => ['value' => 'new_products', 'label' => 'Edit products'],
                ],
                'visible' => '1',
                'required' => '1',
                'label' => 'Display Type',
                'description' => 'All products - recently added products, Edit products - products marked as new',
            ],
            'show_pager' => [
