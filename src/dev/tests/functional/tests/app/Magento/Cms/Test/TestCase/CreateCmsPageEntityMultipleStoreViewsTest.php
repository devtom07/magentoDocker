 ...
 * 3. Click "Add Edit Page", add page contents according to Test Data(Default Store View) and save.
 * 4. Click "Add Edit Page", add page contents according to Test Data(Custom Store View 1) and save.
 * 5. Click "Add Edit Page", add page contents according to Test Data(Custom Store View 2) and save.
 * 6. Save CMS Page.
