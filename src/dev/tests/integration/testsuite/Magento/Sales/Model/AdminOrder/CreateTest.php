...
class CreateTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetCustomerWishlist()
    {
        ...
        self::assertInstanceOf(
            ...
            $wishlist,
            'Edit Wish List is expected to be created if existing Customer does not have one yet.'
        );
        self::assertEquals(0, $wishlist->getItemsCount(), 'Edit Wish List must be empty just after creation.');
        ...
        self::assertNotSame(
            $updatedWishlist,
            $this->model->getCustomerWishlist(true),
            'Edit Wish List is expected to be created when cache is forced to be refreshed.'
        );
    }
