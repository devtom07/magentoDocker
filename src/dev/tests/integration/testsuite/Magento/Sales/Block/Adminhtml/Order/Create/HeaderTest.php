    ...
    public function toHtmlDataProvider()
    {
        ...
        return [
            'Customer and store' => [
                ...
                $defaultStoreView,
                'Create Edit Order for John Smith in Default Store View',
            ],
            'No store' => [$customerIdFromFixture, null, 'Create Edit Order for John Smith'],
            'No customer' => [null, $defaultStoreView, 'Create Edit Order in Default Store View'],
            'No customer, no store' => [null, null, 'Create Edit Order for Edit Customer']
        ];
    }
}
