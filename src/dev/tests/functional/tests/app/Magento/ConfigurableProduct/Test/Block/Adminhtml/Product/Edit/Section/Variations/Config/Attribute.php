...
class Attribute extends Form
{
    ...
    /**
     * Selector for "Create Edit Variations Set"
     *
     * @var string
     */
    protected $createNewVariationSet = '[title="Create Edit Attribute"]';

    /**
     * Edit attribute frame selector
     *
     * @var string
     */
    ...
    /**
     * Selector for "Edit Attribute" block
     *
     * @var string
     */
    ...
    /**
     * Selector for "Save Attribute" button on "Edit Attribute" dialog window
     *
     * @var string
     */
    ...
    /**
     * Selector for "Create Edit Value" button
     *
     * @var string
     */
