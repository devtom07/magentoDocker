...
/**
 * Check that created Catalog Edit Products List widget displayed on frontend on Category Page.
 */
class AssertWidgetCatalogNewProductsList extends AbstractConstraint
{
    ...
    /**
     * Assert that created Catalog Edit Products List widget displayed on frontend on Category Page.
     *
    ...
    public function processAssert(
        ...
        \PHPUnit\Framework\Assert::assertTrue(
            $catalogCategoryView->getWidgetView()->isWidgetVisible($widget, 'Edit Products'),
            'Widget is absent on Category page.'
        );
        \PHPUnit\Framework\Assert::assertEquals(
            $products,
            $this->catalogCategoryView->getViewBlock()->getProductsFromCatalogNewProductsListBlock(),
            'There are wrong products or products are absent on Catalog Edit Products List block on Category page.'
        );
    }
    ...
    {
        return "Catalog Edit Products List widget is present on Category page.";
    }
}
